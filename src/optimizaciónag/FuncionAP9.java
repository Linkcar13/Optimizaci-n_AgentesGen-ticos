 ...
 * Función número 1
 */
public class FuncionAP9 extends FitnessFunction {
    ...
    protected double evaluate(IChromosome ic) {
       ...
       //Integer g10 = (Integer)ic.getGene(9).getAllele();   // y
        ...
        //System.out.println(x_value + " ; " + y_value);
                double value =1/(2*log(x_value)-3-log(x_value/10)); // simplificada por localidad se mantienen los puntos criticos 
                if (value < 0){
                return 0;
                }
                else{
