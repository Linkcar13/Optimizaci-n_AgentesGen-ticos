 ...
 * Función número 1
 */
public class FuncionAP1 extends FitnessFunction {
    ...
    protected double evaluate(IChromosome ic) {
       ...
       //Integer g10 = (Integer)ic.getGene(9).getAllele();   // y
        ...
        //System.out.println(x_value + " ; " + y_value);
                return 1/((((pow(x_value,2)-(5*x_value)+9)*log(2))+log(125)-3)); //inversa
                //return 1/((pow((log(pow(2,2-x_value))),2+x_value))+log(1250)-4);
